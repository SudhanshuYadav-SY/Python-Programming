...
driver.find_element(By.XPATH,"//*[@value='Login']").click()                                 #Identify Web Element Using XPATH
driver.find_element(By.LINK_TEXT,"compendiumdev").click()                                   #Identify Web Element Using LINK TEXT
driver.find_element(By.CSS_SELECTOR,"input[value='Login']").click()                         #Identify Web Element Using CSS SELECTOR
